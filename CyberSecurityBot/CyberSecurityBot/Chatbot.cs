...
namespace CyberSecurityBot
{
    public class Chatbot
    {
        ...
        public string GetResponse(string input)
        {
            ...
            {
                return "It's understandable to feel worried about cybersecurity. I'm here to help you stay safe online by providing advice and best practices.";
            }

            if (sentiment == "confused")
            {
                return "Cybersecurity can seem confusing at first. Feel free to ask me about phishing, passwords, privacy, ransomware or safe browsing.";
            }

            if (sentiment == "frustrated")
            {
                return "I understand your frustration. Cybersecurity can be challenging, but I'll do my best to help you.";
            }

            if (sentiment == "curious")
            {
                return "That's great! Curiosity is one of the best ways to learn about cybersecurity. Ask me anything.";
            }
